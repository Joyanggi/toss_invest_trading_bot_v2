...
- 주요 검증 구간 중 하나라도 수익이 음수인 전략을 활성 후보에서 제외
...
2026-07-15 기준 첫 비교에서는 높은 승률의 평균회귀 전략이 반드시 더 안정적이지 않았습니다. RSI(2)와 볼린저 재진입은 음수 수익 구간 때문에 탈락했고, RSI(14), EMA20/100, Donchian 55/20, 12-1개월 상대 모멘텀이 1차 생존했습니다. EMA 추세 계열이 수익, 최대낙폭, 비용 민감도 사이에서 가장 일관된 후보였지만, 현재 S&P 100 구성 종목을 과거에도 사용한 생존편향이 있으므로 실전 전략으로 확정하지 않았습니다.
